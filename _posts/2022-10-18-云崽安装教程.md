...
> **提示**
>
> - 安装已经编译好的包 FFmpeg 5.1.2。
>
>   1. 下载 FFmpeg.tar.gz
>
>      ```sh
>      cd /usr/local && \
>      sudo wget https://github.com/LetsShareAll/file/releases/download/files/FFmpeg.tar.gz
>      ```
>
>   2. 解压 FFmpeg.tar.gz
>
...
>      sudo ln -s /usr/local/ffmpeg/share/* /usr/local/share/
>      ```
...
> **提示**
>
> - 安装已经编译好的包 Python 3.11.0。
>
>   1. 下载 Python.tar.gz
>
>      ```sh
>      sudo cd /usr/local && \
>      sudo wget https://github.com/LetsShareAll/file/releases/download/files/Python.tar.gz
>      ```
>
>   2. 解压 Python.tar.gz
>
...
>      sudo ln -s /usr/local/python/share/* /usr/local/share/
>      ```
>
>   4. 创建 `python` 链接
>
