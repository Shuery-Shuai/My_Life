...
- 若要使用语音功能，则需要[安装 FFmpeg](#安装-ffmpeg-可选 "安装 FFmpeg")，Debian/Ubuntu/Fedora/RHEL/CentOS~~/Alpine~~ 就需要安装编译库。
...
- 教程更新地址：[锐毅的博客](https://life.shuery.lssa.fun/教程/应用/云崽/云崽安装教程.html "云崽安装教程 - 锐毅的博客")
